...
export default function ClimbingMapMinimal() {
  ...
  useEffect(() => {
    ...
    /* ── Markers — kolorowa kropka bez ramki ── */
    climbingWalls.forEach((wall) => {
      const color = TYPE_COLOR[wall.type] ?? '#555';
      ...
      <div className={styles.wrapper}>
        ...
        {selectedWall && (
            ...
            <span
                ...
                style={{ background: TYPE_COLOR[selectedWall.type] }}
            />
                <div>
                  ...
                  <span
                      ...
                      style={{
                        background: TYPE_COLOR[selectedWall.type] + '22',
                        color: TYPE_COLOR[selectedWall.type],
                      }}
                  >
                {selectedWall.type}
              </span>
